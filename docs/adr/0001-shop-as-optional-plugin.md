...
Khao Pad (v2.0) is a website platform. It deliberately does *not* try
...
routes. It sits *cleanly beside* Khao Pad's existing v2.0 surface —
...
export default {
  ...
  // /cms/settings card. Renders under a "Plugins" section with the
...
New card in `/cms/settings` under a "Plugins" section:
...
**Escape hatch:** an operator who *does* want a CRUD admin can
...
### What plugins do *not* do (in v0.1)
