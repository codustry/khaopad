...
export class GitHubContentProvider implements ContentProvider {
	...
	async listArticles(_filter?: ArticleFilter): Promise<PaginatedResult<ArticleRecord>> {
		throw new Error('GitHubContentProvider not yet implemented');
	}
	...
	async updateArticle(_id: string, _data: ArticleUpdateInput): Promise<ArticleRecord> {
		throw new Error('GitHubContentProvider not yet implemented');
	}
	...
	async createCategory(
		_data: { slug: string; localizations: CategoryRecord['localizations'] },
	...
	async createTag(
		_data: { slug: string; localizations: TagRecord['localizations'] },
	): Promise<TagRecord> {
		throw new Error('GitHubContentProvider not yet implemented');
	}
